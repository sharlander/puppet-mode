...
<kbd>C-c C-t</kbd> | Toggle string quoting between single and double
<kbd>C-c C-d</kbd> | Blank the string at point
...
<kbd>C-c C-q</kbd> | Set quotes around the word before cursor
